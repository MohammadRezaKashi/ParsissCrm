...
func ConvertPaymentStatusToInt(s string) int {
	...
	case "پرداخت شد", "پرداخت شد ":
		return 1
	case "پرداخت نشد", "پرداخت نشد ", "پرداخت نشده ":
		return 2
	case "رایگان", "رایگان ":
		return 3
	case "طرح سلامت", "طرح سلامت ":
		return 4
	case "توسط بیمارستان", "توسط بیمارستان ", "بیمارستان ":
		return 5
	case "کنگره", "کنگره ":
		return 6
	case "آموزشی", "آموزشی ":
...
func ConvertImageValidityToInt(s string) int {
	switch s {
	case "چک نشده ", "چک نشده", "چک نشد ", "چک  نشده":
		return 1
	case "ندارد", "ندارد ", "نداشت ", "نداشت", "انجام نشده ", "نشده ":
		return 2
	case "چک شد / تحویل بیمار ", "چک شد / تحویل بیمار", "چک شده در شرکت ", "چک شده در بیمارستان ", "چک شده در عرفان ",
		"چک شد / تحویل شد ", "چک شد / تحویل شرکت ", "چک شد / شرکت ", "چک شد /تحویل بیمار ", "چک شد/تحویل بیمار ",
		"چک شد/ تحویل بیمار ", "چک شد ":
		return 3
	case "نامعتبر", "نامعتبر ", "چک شد طبق پروتکل نبود ", "چک شد طبق پروتکل نبود/تحویل بیمار ",
		"چک شد / با پروتکل نبود ", "چک شد / سی دی خوب رایت نشده بود ", "چک شد با پروتکل نبود ", "سی دی باز نشد ",
		"چک شد رایت نشده بود ":
		return 4
	}
	return 0
